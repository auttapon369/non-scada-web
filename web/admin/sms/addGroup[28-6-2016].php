		...
		<table class="table table-responsive">
			...
			?>
				<tr>
					<td><?=$row?></td>
					<td><?=$r_group['email']?></td>
					<td><?=$r_group['telnum']?></td>
					<td><a href="./?menu=Setting&view=caution&page=editUserGroup&fuser_id=<?=$r_group['id']?>"></a></td>
					<td><a href="./?menu=Setting&view=caution&page=delUserGroup&fuser_id=<?=$r_group['id']?>"></a></td>
				</tr>
			<?php
				$row++;
			} //end while
