...
while ( $sys_arr = odbc_fetch_array($result) )
{
		...
		$strf=gen_data("rf",$sys_arr['Check_rf'],$row['DT'],$row_hour['rf'],$row_day['rfday'],$rowal['rfw'],$rowal['rfd']);
		$stwl_u=gen_data("wl",$sys_arr['Check_wl_up'],$row['DT'],$row['WL_UP'],$row_day['rfday'],$rowal['wlw'],$rowal['wld']);
		$stwl_d=gen_data("wl",$sys_arr['Check_wl_dw'],$row['DT'],$row['WL_DOWN'],$row_day['rfday'],$rowal['wl2w'],$rowal['wl2d']);
		if($_GET['view'] == "scada")
		{
