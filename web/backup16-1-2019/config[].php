...
switch ( $sv['host'] )
{
	...
	case '192.168.1111.209':
		$sv['user'] = 'sa';
		$sv['pass'] = 'ata+ee&c';
		$sv['db'] = 'nonburi';
		//define('HTML', 'http://192.168.1.209:8080/eweb/project/non2016/');
		define('PATH_SIGNALR', 'http://192.168.1.209/scadahost/signalr/hubs');
		break;

	// case 'cctvexpert.dyndns.org':
	// 	$sv['user'] = 'sa';
	// 	$sv['pass'] = 'ata+ee&c';
	// 	$sv['db'] = 'nonburi';
...
define('PATH_PLUGIN', PATH_ROOT.'themes/plugins/');
