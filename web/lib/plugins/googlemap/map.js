	...
	(
  		...
  		function(key, DATA) 
  		{
			...
			var html =	'<div class="popup">'
						...
						{
							w1 = DATA.data.wl_up.value.status;
							...
							{
								w2 = DATA.data.wl_down.value.status;
							...
							s = ( [w1,w2].indexOf("warning") > -1 ) ? "warning" : s;
							s = ( [w1,w2].indexOf("danger") > -1 ) ? "danger" : s;
							s = ( [w1,w2].indexOf("black") > -1 ) ? "black" : s;
							s = ( [w1,w2].indexOf("gray") > -1 ) ? "gray" : s;
							s = ( [w1,w2].indexOf("white") > -1 ) ? "white" : s;
							ic_wl = '<span class="icon wl ' + s + '"></span>';
						}
